<div class="profile-form-section">
    <div class="alert alert-danger" role="alert">
        ...
        <strong><?php echo e(__('Warning:')); ?></strong> <?php echo e(__('Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain.')); ?>

    </div>

    <button type="button" class="btn btn-danger btn-lg" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal">
        <i class="fas fa-trash-alt me-2"></i><?php echo e(__('Delete Account')); ?>
            ...
            <div class="modal-content border-danger">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="confirmDeleteModalLabel">
                        <i class="fas fa-exclamation-triangle me-2"></i><?php echo e(__('Confirm Account Deletion')); ?>
                ...
                <form method="post" action="<?php echo e(route('profile.destroy')); ?>" id="deleteAccountForm">
                    ...
                    <div class="modal-body">
                        ...
                        <h6 class="text-center mb-3"><?php echo e(__('Are you sure you want to delete your account?')); ?></h6>
                        
                        <p class="text-muted text-center mb-4">
                            <?php echo e(__('This action cannot be undone. All of your data, orders, and account information will be permanently deleted.')); ?>

                        </p>
                        
                        <div class="mb-3">
                            <label for="delete_password" class="form-label">
                                <i class="fas fa-lock me-2"></i><?php echo e(__('Enter your password to confirm')); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       placeholder="<?php echo e(__('Your current password')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label text-danger" for="confirmDeletion">
                                <strong><?php echo e(__('I understand that this action is permanent and cannot be undone.')); ?></strong>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger" id="confirmDeleteBtn" disabled>
                            <i class="fas fa-trash-alt me-2"></i><?php echo e(__('Delete My Account')); ?>
...
<?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/profile/partials/delete-user-form.blade.php ENDPATH**/ ?>