...
<div class="container">
    <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h1 class="hero-title neon-glow">Welcome to <?php echo e(config('app.name', 'Valult64')); ?></h1>
                <p class="hero-subtitle subtitle-glow">Discover premium quality products and authentic collections for true enthusiasts</p>
                <div class="mt-4">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-accent btn-lg me-3 banner-btn" aria-label="Shop now - go to products">Shop Now</a>
                ...
                <div class="col-md-4 mb-4">
                    <div class="product-card text-center category-card">
                        <div class="product-info">
                            ...
                            <h5 class="product-title"><?php echo e($category->name); ?></h5>
                            <p class="text-muted"><?php echo e($category->products_count ?? 0); ?> products</p>
                            <a href="<?php echo e(route('products.index', ['category' => $category->id])); ?>" class="btn btn-accent category-btn" aria-label="View products in <?php echo e($category->name); ?> category">View Products</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
            ...
            <?php $__currentLoopData = $featuredProducts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                    ...
                    <?php endif; ?>
                            ...
                            <div class="d-grid">
                                <a href="<?php echo e(route('products.show', $product->id)); ?>" class="btn btn-accent checkout-glow" aria-label="View details for <?php echo e($product->name); ?>">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12 text-center mt-4">
                <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline-accent btn-lg" aria-label="View all products">View All Products</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-5">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center mb-5">
                <h2 class="fw-bold">Why Choose <?php echo e(config('app.name', 'Valult64')); ?></h2>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/home.blade.php ENDPATH**/ ?>