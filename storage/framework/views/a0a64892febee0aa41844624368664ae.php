...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" data-theme="dark">
    ...
    <title><?php echo e(config('app.name', 'VergeFlow')); ?> - Login</title>
...
<body>
    <div class="login-container">
        <a href="/" class="login-logo">
            <img src="<?php echo e(asset('logo.png')); ?>" alt="Vault64 Logo" style="width:180px;height:auto;max-width:100%;object-fit:contain;">
        </a>
