                ...
                <div class="col-lg-6">
                    <div class="hero-content">
                        ...
                        <div class="hero-buttons">
                            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-accent btn-lg">
                                <i class="fas fa-shopping-bag me-2"></i>Shop Now
                            </a>
                            <a href="<?php echo e(route('home')); ?>" class="btn btn-outline-accent btn-lg">
            ...
            <div class="row">
                ...
                <div class="col-md-3 mb-4">
                    <div class="category-card">
                        ...
                        <p class="category-count"><?php echo e($category->products_count); ?> products</p>
                        <a href="<?php echo e(route('products.index', ['category' => $category->slug])); ?>" class="category-link">
                ...
                <div class="col-md-3 mb-4">
                    <div class="product-card">
                        ...
                        <div class="product-content">
                            ...
                            <p class="product-category"><?php echo e($product->category->name ?? 'No Category'); ?></p>
                            ...
                            <div class="product-actions">
                                ...
                                <form action="<?php echo e(route('cart.add')); ?>" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-accent btn-sm" title="Add this product to your cart" aria-label="Add <?php echo e($product->name ?? 'this product'); ?> to cart">
            ...
            <div class="cta-card">
                <div class="cta-content">
                    ...
                    <div class="cta-buttons">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-accent btn-lg">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/welcome.blade.php ENDPATH**/ ?>