                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Orders</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($totalOrders ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Revenue</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">₹<?php echo e(number_format($totalRevenue ?? 0, 2)); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="badge badge-<?php echo e(isset($activeApiIntegrations) && $activeApiIntegrations > 0 ? 'success' : 'warning'); ?>">
                                <?php echo e($activeApiIntegrations ?? 0); ?> Active
                            </span>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalProducts ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalCategories ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalCustomers ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalOrders ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalReviews ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($totalCoupons ?? 0); ?></h5>
