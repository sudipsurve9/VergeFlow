                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Total Orders</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['total_orders'] ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Total Revenue</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">₹<?php echo e(number_format($stats['total_revenue'] ?? 0, 2)); ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Total Products</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($stats['total_products'] ?? 0); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('admin.products.create')); ?>" class="btn btn-primary btn-block" aria-label="Add new product">
                                <i class="fas fa-plus"></i> Add Product
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('admin.categories.create')); ?>" class="btn btn-success btn-block" aria-label="Add new category">
                                <i class="fas fa-tags"></i> Add Category
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('admin.coupons.create')); ?>" class="btn btn-warning btn-block" aria-label="Add new coupon">
                                <i class="fas fa-ticket-alt"></i> Add Coupon
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="<?php echo e(route('admin.banners.create')); ?>" class="btn btn-info btn-block" aria-label="Add new banner">
        ...
        <div class="col-lg-8">
            <div class="card shadow" role="region" aria-label="Recent orders">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-sm btn-primary" aria-label="View all orders">View All</a>
                </div>
                <div class="card-body">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $recent_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($order->user_name ?? 'Guest'); ?></td>
                                            <td>₹<?php echo e(number_format($order->total_amount, 2)); ?></td>
                                            <td>
                                                <span class="badge badge-<?php echo e($order->status == 'pending' ? 'warning' : ($order->status == 'processing' ? 'info' : ($order->status == 'delivered' ? 'success' : 'danger'))); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge <?php echo e(isset($stats['active_api_integrations']) && $stats['active_api_integrations'] > 0 ? 'bg-success' : 'bg-warning'); ?> text-white px-2 py-1">
                                <?php echo e($stats['active_api_integrations'] ?? 0); ?> Active
                            </span>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="text-muted"><?php echo e(now()->format('M d, Y H:i')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_products'] ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_categories'] ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_users'] ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_orders'] ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_reviews'] ?? 0); ?></h5>
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="text-center">
                                ...
                                <h5><?php echo e($stats['total_coupons'] ?? 0); ?></h5>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>