...
<body>
    ...
    <div class="login-card">
        ...
        <div class="login-body">
            ...
            <form method="POST" action="<?php echo e(route('super_admin.login')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('password.request')); ?>" class="text-muted text-decoration-none">
            ...
            <div class="text-center">
                ...
                <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-outline-secondary btn-sm">
...
</html> <?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/auth/super_admin_login.blade.php ENDPATH**/ ?>