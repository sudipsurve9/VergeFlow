...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Logo section */
            .main-header .col-md-3:first-child {
                display: flex;
                align-items: center;
                justify-content: flex-start;
            }
            
            /* Search section - hide on mobile to save space */
            .main-header .col-md-6 {
                display: none;
            }
            ...
            .main-header .col-md-3:last-child .d-flex {
                align-items: center;
                gap: 10px;
            }
                ...
                <div class="row align-items-center py-3">
                    ...
                    <div class="col-md-3 text-end">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <button class="navbar-toggler d-lg-none ms-3" type="button" id="mobileMenuToggle" aria-controls="mobileNav" aria-expanded="false" aria-label="Toggle navigation menu">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (mobileMenuToggle && mobileNav) {
                mobileMenuToggle.addEventListener('click', function(e) {
                    ...
                    const isExpanded = mobileNav.classList.contains('mobile-nav-open');
                    
                    if (isExpanded) {
                        // Close menu
                        mobileNav.classList.remove('mobile-nav-open', 'show');
                        mobileMenuToggle.setAttribute('aria-expanded', 'false');
                    } else {
                        // Open menu
                        mobileNav.classList.add('mobile-nav-open', 'show');
