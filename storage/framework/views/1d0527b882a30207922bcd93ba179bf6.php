<?php $__env->startSection('title', 'Your Address Book'); ?>
                ...
                <div class="card theme-card h-100" style="box-shadow: 0 0 32px var(--accent-color, #FFB30055), 0 0 64px var(--accent-glow, #FF6A0033);">
                    <div class="card-header theme-card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <?php endif; ?>
                            <div>
                                <h5 class="mb-0 neon-glow"><?php echo e($address->display_name); ?></h5>
                                <small class="text-muted"><?php echo e(ucfirst($address->address_type)); ?> Address</small>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <!-- Address Details -->
                        <div class="mb-3">
                            <h6 class="fw-bold text-accent"><?php echo e($address->name); ?></h6>
                            <p class="text-muted mb-1"><i class="fas fa-phone me-1"></i><?php echo e($address->phone); ?></p>
                            <div class="mt-2">
                                ...
                                <?php if($address->landmark): ?>
                                    <p class="mb-1 text-muted"><i class="fas fa-map-pin me-1"></i>Near <?php echo e($address->landmark); ?></p>
                                <?php endif; ?>
                                <p class="mb-0"><?php echo e($address->city); ?>, <?php echo e($address->state); ?> - <?php echo e($address->postal_code); ?></p>
                            </div>
                        </div>
                        ...
                        <?php if($address->delivery_instructions): ?>
                            <div class="alert alert-warning py-2 mb-3">
                                ...
                                <small><?php echo e($address->delivery_instructions); ?></small>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="card-footer d-flex flex-wrap gap-2 justify-content-center">
                        <button onclick="editAddress(<?php echo e($address->id); ?>)" class="btn btn-sm btn-outline-accent icon-btn-glow">
                            <i class="fas fa-edit me-1"></i>Edit
                        </button>
                        
                        <?php if(!$address->is_default_shipping && in_array($address->address_type, ['shipping', 'both'])): ?>
                            <button onclick="setDefaultShipping(<?php echo e($address->id); ?>)" class="btn btn-sm btn-outline-success icon-btn-glow">
                                <i class="fas fa-truck me-1"></i>Default Shipping
                            </button>
                        <?php endif; ?>
                        
                        <?php if(!$address->is_default_billing && in_array($address->address_type, ['billing', 'both'])): ?>
                            <button onclick="setDefaultBilling(<?php echo e($address->id); ?>)" class="btn btn-sm btn-outline-info icon-btn-glow">
                                <i class="fas fa-credit-card me-1"></i>Default Billing
                            </button>
                        <?php endif; ?>
                        
                        <button onclick="deleteAddress(<?php echo e($address->id); ?>)" class="btn btn-sm btn-outline-danger icon-btn-glow">
...
function openAddAddressModal() {
    ...
    document.getElementById('addressForm').action = '<?php echo e(route("addresses.store")); ?>';
...
<?php echo $__env->make('layouts.app_modern', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/addresses/index.blade.php ENDPATH**/ ?>