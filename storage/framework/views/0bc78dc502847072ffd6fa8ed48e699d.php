        ...
        <div class="col-lg-6">
            <div class="product-details theme-card">
                <div class="product-category mb-2">
                    <span class="badge badge-accent category-glow"><?php echo e($product->category->name); ?></span>
                </div>
                
                <h1 class="product-title neon-glow mb-3"><?php echo e($product->name); ?></h1>
                ...
                <div class="product-price price-glow mb-4">
                    <?php if($product->sale_price): ?>
                        ...
                        <span class="discount-badge">Save <?php echo e(round((($product->price - $product->sale_price) / $product->price) * 100)); ?>%</span>
                    <?php else: ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <?php if($product->stock_quantity > 0): ?>
                                <span class="text-success"><?php echo e($product->stock_quantity); ?> available</span>
                            <?php else: ?>
                ...
                <?php if($product->stock_quantity > 0): ?>
                    <form action="<?php echo e(route('cart.add')); ?>" method="POST" class="mb-4" aria-label="Add product to cart form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <button type="submit" class="btn btn-accent w-100 btn-lg checkout-glow" aria-label="Add <?php echo e($product->name); ?> to cart" title="Add this product to your cart">
                                    <i class="fas fa-cart-plus me-2"></i>Add to Cart
                                </button>
                            </div>
                        </div>
                    </form>
                    <button type="button" class="btn btn-outline-danger w-100 wishlist-btn mb-4" data-product-id="<?php echo e($product->id); ?>" aria-label="<?php echo e($inWishlist ? 'Remove' : 'Add'); ?> <?php echo e($product->name); ?> to wishlist">
                        <i class="fa<?php echo e($inWishlist ? 's' : 'r'); ?> fa-heart me-1"></i>
                        <span class="wishlist-btn-text"><?php echo e($inWishlist ? 'Remove from Wishlist' : 'Add to Wishlist'); ?></span>
                    </button>
                <?php else: ?>
                ...
                <div class="product-actions">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline-accent me-2 banner-btn" aria-label="Back to all products">
                        <i class="fas fa-arrow-left me-2"></i>Back to Products
                    </a>
                    <a href="<?php echo e(route('products.index', ['category' => $product->category->slug])); ?>" class="btn btn-outline-secondary banner-btn" aria-label="More products in <?php echo e($product->category->name); ?> category">
                        <i class="fas fa-tags me-2"></i>More <?php echo e($product->category->name); ?>
        ...
        <div class="col-12">
                ...
                <?php if($product->total_reviews > 0): ?>
                    <div class="d-flex align-items-center justify-content-center mb-3">
                        <div class="rating-display me-3">
                            <span class="rating-stars"><?php echo e($product->rating_stars); ?></span>
                            <span class="rating-number ms-2"><?php echo e(number_format($product->average_rating, 1)); ?> out of 5</span>
                        </div>
                        <span class="text-muted">(<?php echo e($product->total_reviews); ?> <?php echo e(Str::plural('review', $product->total_reviews)); ?>)</span>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="text-center mb-4">
                <?php if(auth()->guard()->check()): ?>
                    <?php if($canReview): ?>
                        <a href="<?php echo e(route('products.reviews.create', $product)); ?>" class="btn btn-accent me-2">
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-accent">
                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="review-card theme-card mb-4">
                            <div class="review-header d-flex justify-content-between align-items-start">
                                <div class="reviewer-info">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <div>
                                            <h6 class="reviewer-name mb-0"><?php echo e($review->user->name); ?></h6>
                            ...
                            <div class="review-rating mb-2">
                                <span class="rating-stars"><?php echo e($review->stars); ?></span>
                                <span class="rating-number ms-2"><?php echo e($review->rating); ?>/5</span>
                            </div>

                            <h6 class="review-title fw-bold mb-2"><?php echo e($review->title); ?></h6>
                            <p class="review-text mb-3"><?php echo e($review->review); ?></p>
                                    ...
                                    <?php if($review->user_id === auth()->id()): ?>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="<?php echo e(route('reviews.edit', $review)); ?>">
                                                    <i class="fas fa-edit me-2"></i>Edit
                                                </a></li>
                                                <li><a class="dropdown-item text-danger" 
                                                       href="#" 
                                                       onclick="deleteReview(<?php echo e($review->id); ?>)">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card theme-card">
                                <?php if($relatedProduct->image): ?>
                                    <img src="<?php echo e(asset('storage/products/' . $relatedProduct->image)); ?>" 
                                         class="product-image" 
                                ...
                                <div class="product-info">
                                    <div class="product-category category-glow"><?php echo e($relatedProduct->category->name); ?></div>
                                    <h5 class="product-title product-title-glow"><?php echo e($relatedProduct->name); ?></h5>
                                    <p class="product-desc"><?php echo e(Str::limit($relatedProduct->description, 60)); ?></p>
                                    <div class="product-price price-glow">
                                        <?php if($relatedProduct->sale_price): ?>
                                            <span class="original">₹<?php echo e(number_format($relatedProduct->price, 2)); ?></span>
                                    ...
                                    <div class="d-grid">
                                        <a href="<?php echo e(route('products.show', $relatedProduct->slug)); ?>" 
                                           class="btn btn-accent view-btn checkout-glow" aria-label="View details for <?php echo e($relatedProduct->name); ?>">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\VergeFlow\resources\views/products/show.blade.php ENDPATH**/ ?>