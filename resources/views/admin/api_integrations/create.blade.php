...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="fw-bold">Add API Integration</h1>
            ...
            <form action="{{ route('admin.api-integrations.store') }}" method="POST">
                ...
                <div id="shiprocket-fields" class="shiprocket-specific" style="display: none;">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="password" name="password" placeholder="Your Shiprocket password">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="login_url" name="login_url" 
                               value="https://apiv2.shiprocket.in/v1/external/auth/login" 
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="tracking_url" name="tracking_url" 
                               value="https://apiv2.shiprocket.in/v1/external/courier/track/awb/{awb}" 
                ...
                <div id="generic-fields" class="generic-specific">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email_generic" name="email_generic" placeholder="API Email">
                    </div>
                    
                    <div class="mb-3">
                        <label for="password_generic" class="form-label">Password
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="curl_command" name="curl_command" placeholder="https://apiv2.shiprocket.in/v1/external">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="meta" name="meta" rows="4" placeholder='{"key":"value"}'></textarea>
                </div>
...
function testConnection() {
    ...
    fetch("{{ route('admin.api-integrations.test', 0) }}", {
        method: 'POST',
        headers: {
