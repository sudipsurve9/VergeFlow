...
<div class="container" role="main" aria-label="Orders listing main content">
                                    ...
                                    <tr class="order-row">
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="{{ route('orders.show', $order->id) }}" class="btn btn-sm btn-accent icon-btn-glow" aria-label="View order {{ $order->order_number }} details">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
                                                @if($order->status == 'pending')
                                                    <form action="{{ route('orders.cancel', $order->id) }}" method="POST" class="d-inline" aria-label="Cancel order {{ $order->order_number }}">
                                                        @csrf
                                                        <button type="submit" class="btn btn-sm btn-outline-danger cancel-btn" aria-label="Cancel order {{ $order->order_number }}" onclick="return confirm('Are you sure you want to cancel this order?')">
    ...
    @else
        <div class="empty-state">
            ...
            <a href="{{ route('products.index') }}" class="btn btn-accent btn-lg" aria-label="Start shopping - go to products">
