                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="site_name" name="site_name" 
                                           value="{{ old('site_name', 'VergeFlow Multi-Client System') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="site_description" name="site_description" 
                                           value="{{ old('site_description', 'Multi-client e-commerce platform') }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="mail_from_address" name="mail_from_address" 
                                           value="{{ old('mail_from_address', 'noreply@vergeflow.com') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="mail_from_name" name="mail_from_name" 
                                           value="{{ old('mail_from_name', 'VergeFlow System') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="session_lifetime" name="session_lifetime" 
                                           value="{{ old('session_lifetime', 120) }}" min="30" max="1440" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="password_min_length" name="password_min_length" 
                                           value="{{ old('password_min_length', 8) }}" min="6" max="20" required>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="require_password_complexity" 
                                               ...
                                               {{ old('require_password_complexity') ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="max_clients" name="max_clients" 
                                           value="{{ old('max_clients', 100) }}" min="1" max="1000" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="default_client_theme" name="default_client_theme">
                                        <option value="modern" {{ old('default_client_theme') == 'modern' ? 'selected' : '' }}>Modern</option>
                                        <option value="classic" {{ old('default_client_theme') == 'classic' ? 'selected' : '' }}>Classic</option>
                                        <option value="default" {{ old('default_client_theme') == 'default' ? 'selected' : '' }}>Default</option>
                                        <option value="apparel" {{ old('default_client_theme') == 'apparel' ? 'selected' : '' }}>Apparel</option>
                                        <option value="webshop" {{ old('default_client_theme') == 'webshop' ? 'selected' : '' }}>WebShop</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="auto_create_admin" 
                                               ...
                                               {{ old('auto_create_admin', 1) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="allow_client_customization" 
                                               ...
                                               {{ old('allow_client_customization', 1) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="log_retention_days" name="log_retention_days" 
                                           value="{{ old('log_retention_days', 30) }}" min="7" max="365" required>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <div class="text-center">
                                    <a href="{{ route('super_admin.templates.index') }}" class="btn btn-primary btn-lg">
