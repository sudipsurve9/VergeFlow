    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'vergeflow_main'),
        ...
        'main' => [
            ...
            'database' => env('MAIN_DB_DATABASE', 'vergeflow_main'),
        ...
        'client' => [
            ...
            'database' => env('CLIENT_DB_DATABASE', 'vergeflow_client'),
            ...
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('CLIENT_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
