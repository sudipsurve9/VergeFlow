...
try {
    ...
    echo "🔍 Testing Address Save with Final Corrected Model\n";
    echo "=================================================\n";
    ...
    // Test 2: Create address using Address model with corrected field names
    echo "💾 Creating address using corrected Address model...\n";
    ...
    $address->address_line1 = '123 Test Street'; // This should map to address_line_1
    $address->address_line2 = 'Apt 4B'; // This should map to address_line_2
    ...
    if ($saved) {
        ...
        if ($savedAddress) {
            ...
            echo "   - Company: {$savedAddress->company}\n";
            echo "   - Phone: {$savedAddress->phone}\n";
            echo "   - Address Line 1: {$savedAddress->address_line1}\n"; // Compatibility accessor
            echo "   - Address Line 2: {$savedAddress->address_line2}\n"; // Compatibility accessor
            echo "   - Actual DB Field 1: {$savedAddress->address_line_1}\n"; // Actual DB field
            echo "   - Actual DB Field 2: {$savedAddress->address_line_2}\n"; // Actual DB field
        ...
        echo "✅ Address line compatibility (address_line1 ↔ address_line_1) is working.\n";
