...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Manually validate addresses exist and belong to user
            $shippingAddress = Address::where('id', $request->shipping_address_id)
                ->where('user_id', Auth::id())
                ->first();
            
            if (!$shippingAddress) {
                return back()->withErrors(['shipping_address_id' => 'Selected shipping address is invalid.'])->withInput();
            }
            ...
            if (!$billingAddress) {
                return back()->withErrors(['billing_address_id' => 'Selected billing address is invalid.'])->withInput();
            }
